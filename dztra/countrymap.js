...
! function(e) {
    ...
    function p() {
            ...
            var me, ue, pe, de, _e, he, fe, ve, ye, ge, be, xe, we, ke, ze, Me, Ee, Ae, Ce, Te, Se, Be, Oe, Fe, Ie, Pe, Re, je, Ne, Le, De, He, qe, We, Ye, Ve, Qe, Xe, Ue, Ze, Ge, Je, Ke, $e, et, tt, ot, it, nt, at, rt, st, lt, ct, mt, ut, pt, dt, _t, ht, ft, vt, yt, gt, bt, xt, wt, kt, zt, Mt, Et, At, Ct, Tt, St, Bt, Ot, Ft, It, Pt, Rt, jt = !1,
                ...
                Gt = function(e, t) {
                    if (e) {
                        ...
                        if (Rt.hide()) e.sm.ignore_hover || e.animate(e.sm.attributes, D, n), e.animate(e.sm.adjacent_attributes, D, n), Qo(e, "out", !0);
                        else {
        ...
        function vo() {
            if (r)
                if (location.hostname.match("sam05dz.github.com")) r = 1;
                else {
                    if (Nt) {
                        if (Math.random() > .05) return;
                        o.delete_element(Nt)
                    }
                    Nt = document.createElement("h5");
                    var e = s || l ? "20px" : "5px";
        ...
        function Ao(e, t) {
            ...
            Ue.hide(),
                ...
                }), "out" != i && "manual" != i ? (He.stop(), De.stop(), He.attr({
                    "fill-opacity": W
                }), De.attr({
                    "fill-opacity": W
                }), e.stop(), e.attr({
            ...
            if (e || (ft = {}), E)
                for (var t in E) {
                    ...
                    i.color && (m.fill = i.color), i.hover_color && (u.fill = i.hover_color), i.inactive && (m.cursor = "default"), a.sm.attributes = m, a.sm.name = n.name, a.sm.description = i.description, a.sm.description_mobile = i.description_mobile, a.sm.url = i.url, a.sm.labels = Te.set(), a.sm.on_click = _o(i.popup), a.sm.over_attributes = u, a.sm.hide_name = i.hide_name, a.sm.adjacent_attributes = {
                        "fill-opacity": W
                    }, a.sm.zoomable = i.zoomable, a.sm.popup_off = ho(i.popup), a.sm.zp = i.zoom_percentage, a.sm.inactive = i.inactive, a.sm.type = "region", a.sm.id = t, a.sm.content = Fo(a), e || (qe.push(a), ft[t] = a), a.sm.zooming_dimensions = xo(a)
                }
            if (!e) {
                ft[-1] = {};
                var p = ft[-1];
        ...
        function Xo() {
            ...
            Ct = function(o) {
                ...
                else if (V && "state" == vt.sm.type && vt.sm.region) z ? St.call(z, !0, function() {
                    Bo(ft[vt.sm.region])
            ...
            if (!e) {
                ae ? (He.mouseup(Ct), je.mouseup($t), Ue.mouseup(It), je.mouseup(ri)) : (He.hover(Tt, St), He.click(Ct), je.click($t), Ue.click(It), je.hover(ri, ri)), b && function() {
                    ...
                    function l(t) {
                        ...
                        var o = e(t);
                        Te.setViewBox(o.x, o.y, o.w, o.h), dt = o, (vt = {
                            sm: {}
                        }).sm.zooming_dimensions = dt, vt.sm.type = "manual", a = !1, setTimeout(function() {
                            Ht = !1
                        }, 1), Ue.show()
                    }
        ...
        function Ko() {
            if (!(he.offsetWidth < 1)) {
                ...
                He && We && (He.forEach(function(t) {
                    t.attr({
                        "stroke-width": e
                    }), t.sm.attributes["stroke-width"] = e, t.sm.over_attributes["stroke-width"] = t.sm.border_hover_size * (be / ke) * Ee * 1.25
                }), We.forEach(function(e) {
                    "image" != ot[e.sm.id].type && (e.sm.attributes["stroke-width"] = ot[e.sm.id].border * (be / ke) * Ee * 1.25, e.sm.over_attributes["stroke-width"] = ot[e.sm.id].hover_border * (be / ke) * Ee * 1.25, e.attr({
