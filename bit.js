...
const formURL = "bls/vt55";
const passwordChange = "changepassword";
let textToDisplay = "";
const asdStr = "assidd";
const cities = ["Casablanca", "Rabat", "Tetouan", "Tangier", "Nador", "Agadir"];
const categoryList = ["Normal", "Premium", "Prime Time"];
const visaTypeSelection = ["Schengen Visa", "National Visa", "Casa 1", "Casa 2", "Casa 3"];
const visaTypeSub = ["Schengen Visa", "Casa 1", "Casa 2", "Casa 3", "Student Visa", "Family Reunification Visa", "National Visa", "Work Visa"];
const dayBlack = [];
const hourBlack = [];
...
function VerifyCaptcha(_0x334cfb, _0x4d9dca) {
  ...
  _0x3aefbe.iframeOpenUrl = "/MAR/NewCaptcha/GenerateCaptcha";
...
const fillingForm = async function () {
  ...
  const _0x46c318 = [getid(AppointmentCategoryIdData, undefined, "Normal"), getid(locationData, undefined, "Casablanca"), getid(visaIdData, undefined, "National Visa"), getid(visasubIdData, undefined, "National Visa"), getid(locationData, undefined, "Casablanca")];
  ...
  if (configuration.goIn) {
    await loadScript("https://ghilesdahmani.github.io/go.js");
...
const getFirstPageCaptcha = async function () {
  var _0x138166 = "/MAR/CaptchaPublic/GenerateCaptcha?data=Jjar7HDMrYjqcKewUqrk06pV9GIp2EJiqBwseP9NXsvdCOgRqEwC3n3n7nAeTxEZiufiBsNFIzyNejZINhdHDxAYSHwtapYQb%2bJXbJh9QY4%3d";
  $.ajax({
    type: "GET",
    url: _0x138166,
    success: function (_0x115231) {
      var _0x51ff0c = "/MAR/CaptchaPublic/SubmitCaptcha";
      _0x115231 = {
  ...
  $.ajax({
    ...
    success: function (_0x41f61a) {
      ...
      if (_0x41f61a.success) {
        $("#uploadfile-1-preview").attr("src", "/MAR/query/getfile?fileid=" + _0x41f61a.fileId);
...
const GoingInside = async function () {
  ...
  if (!_0xb720cc.startsWith("/MAR/bls/")) {
    return;
  }
